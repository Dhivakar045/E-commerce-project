...
import Tooter from '../src/components/FooterComponent.vue';
import Caro from './components/Carousal.vue';
...
export default {
  ...
  methods: {
    handleLoginSuccess() {
      ...
      // Clear the cache after 1 minute (60000 milliseconds)
      setTimeout(this.clearCache, 60000); // 1 minute
    },
    clearCache() {
      localStorage.removeItem('user');
      this.isAuthenticated = false;
      location.reload(); // Refresh the page to show the login page again
    }
  },
  mounted() {
    ...
    if (user) {
      ...
      setTimeout(this.clearCache, 60000); 
    }
  }
}
</script>
...
body {
  ...
  padding: 0px;
  overflow-x: hidden;
  /* background: url(../public/background_img.jpg); */
}
#app {
